...
namespace StudyMaterialShare.Database.Migrations
{
    ...
    [Migration("20220406081256_RatingUniqueColumns")]
    partial class RatingUniqueColumns
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StudyMaterialShare.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("StudyMaterialShare.Models.Rating", b =>
                {
                    ...
                    b.HasIndex("StudyMaterialId", "UserId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("StudyMaterialShare.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("StudyMaterialShare.Models.Rating", b =>
                {
                    ...
                    b.HasOne("StudyMaterialShare.Models.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
